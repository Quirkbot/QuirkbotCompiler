...
TARGET_HEX = $(OBJDIR)/firmware.hex
TARGET_ELF = $(OBJDIR)/firmware.elf
TARGET_EEP = $(OBJDIR)/firmware.eep
...
LIB_HEADERS         := $(foreach lib, $(SYS_LIBS),  $(call get_library_files,$(lib),h))
...
LIB_PRECOMPILED_HEADERS = $(patsubst $(ARDUINO_LIB_PATH)/%.h,$(OBJDIR)/libs/%.h.gch,$(LIB_HEADERS))
...
# Precompiled headers
PRECOMPILED_HEADERS = $(LIB_PRECOMPILED_HEADERS)
...
#precompile: $(PRECOMPILED_HEADERS)
#
#$(OBJDIR)/libs/Quirkbot/%.h.gch: $(ARDUINO_LIB_PATH)/Quirkbot/%.h
#	@$(MKDIR) $(dir $@)
#	$(CXX) -MMD $(CPPFLAGS) $(CFLAGS) $< -o $@
